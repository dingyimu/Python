...
class WOFComputerPlayer (WOFPlayer):
    ...
    def smartCoinFlip(self):
        ...
        if y>self.difficulty:
            return True
        elif y<=self.difficulty:
            return False
    ...
    def getMove(self, category, obscuredPhrase, guessed):
        d=self.smartCoinFlip()
        #print(d)
        #print(category, obscuredPhrase, guessed)
        #print(self.getPossibleLetters(guessed))
        if self.getPossibleLetters(guessed)==[]:
            return 'pass'
        elif d is True:
            #print("elif d is True:")
            for i in self.SORTED_FREQUENCIES:
                #print(i)
                for i in self.getPossibleLetters(guessed):
                    #print(i)
                    return i
        else:
            #print("elif d is F:")
